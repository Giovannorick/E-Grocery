    ...
    <div class="row m-5 shadow p-5 mb-3 rounded" style="background: #030027">
        <div class="col-4 shadow p-5 mb-3 rounded" style="background: #030027">
            <div class="text-center">
                <img class="shadow mx-3 bg-body rounded" width="360px" src="{{asset('storage/image/display_picture/' . $user->display_picture_link)}}" alt="Error">
            </div>
        </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control w-100" id="first_name" name="first_name" value="{{$user->first_name}}">
                    </div>
                    <div class="mb-2">
                        <label for="email" class="form-label text-warning fw-normal"> {{__('register.email')}}</label>
                        <input type="text" class="form-control w-100" id="email" name="email" placeholder="Email" value="{{$user->email}}">
                    </div>
                    <div class="mt-4">
                        <label for="gender" name="gender" class="form-label text-warning fw-normal d-flex row"> {{__('register.gender')}}</label>
                ...
                <div class="col">
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control w-100" id="last_name" name="last_name" value="{{$user->last_name}}">
                    </div>
                    <div class="mb-2">
                        <label for="role" class="form-label text-warning fw-normal"> {{__('register.role')}}</label>
                        <select class="form-select form-control" name="role" id="role" aria-label="Disabled input example" disabled readonly style="width:350px;">
                                @if ($user->role_id == 1)
                    ...
                    <div class="mb-2">
                        <label for="display_picture" class="form-label text-warning fw-normal"> {{__('register.picture')}}</label>
                        <input type="file" class="form-control w-100" id="display_picture" name="display_picture" value="{{$user->display_picture_link}}">
                    </div>
                    <div class="mb-2">
                        <label for="confirm_password" class="form-label text-warning fw-normal"> {{__('register.confirm_password')}}</label>
                        <input type="password" class="form-control" id="confirm_password" name="confirm_password" value="{{$user->password}}">
                    </div>
                </div>
            </div>
            <div class="text-center">
